...
//     }
   ...
   stage('Docker build and push') {
	 ...
	 echo $secret_key
         ...
         docker login -u AWS -p $DOCKER_LOGIN_PASSWORD 610991027558.dkr.ecr.ap-south-1.amazonaws.com
	 docker build -t 610991027558.dkr.ecr.ap-south-1.amazonaws.com/demo:SAMPLE-PROJECT-${BUILD_NUMBER} .
	 docker push 610991027558.dkr.ecr.ap-south-1.amazonaws.com/demo:SAMPLE-PROJECT-${BUILD_NUMBER}
    ...
    stage('Deploy  K8'){
		  ...
		  chmod +x changebuildnumber.sh
                  ...
                  aws eks --region ap-south-1 update-kubeconfig --name proejct2
                  cat deployment.yml
