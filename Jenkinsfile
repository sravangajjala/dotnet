...
//     }
   ...
   stage('Docker build and push') {
	 ...
	 echo $secret_key
         ...
         docker login -u AWS -p $DOCKER_LOGIN_PASSWORD 191208377811.dkr.ecr.ap-south-1.amazonaws.com/demo1
	 docker build -t 191208377811.dkr.ecr.ap-south-1.amazonaws.com/demo1:SAMPLE-PROJECT-${BUILD_NUMBER} .
	 docker push 191208377811.dkr.ecr.ap-south-1.amazonaws.com/demo1:SAMPLE-PROJECT-${BUILD_NUMBER}
